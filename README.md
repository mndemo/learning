...
<!-- Standalone fragment: ONLY the first accordion ("Application terms") -->
<div th:fragment="legal-stuff-application-terms-accordion">
  <div class="accordion legal-stuff-accordion" id="legal-stuff-application-terms-accordion">
    <button type="button" class="accordion__button" aria-expanded="true"
            aria-controls="legal-stuff-application-terms-content">
      <span th:text="#{legal-stuff.application-terms}"></span>
    </button>
    <div id="legal-stuff-application-terms-content"
...
<div th:fragment="legal-terms-prompt" class="spacing-below-60"
     th:with="firstAccordionId = ${pageName == 'legalStuff' ? 'prepare-to-apply-accordion' : 'prepare-to-apply-accordion-second-signature'}"
     >

<div class="accordion legal-stuff-accordion" th:id="${firstAccordionId}">
        <button href="#" class="accordion__button" aria-expanded="true" aria-controls="a1" >
            <span th:text="#{legal-stuff.application-terms}"></span>
        </button>
    <div id="a1" class="accordion__content textarea-readonly legal-stuff-window spacing-below-35">
        <h2 class="h3" th:text="#{legal-stuff.summary}"></h2>
        <div th:text="|• #{legal-stuff.you-have-been-honest-on-this-application}|"></div>
        <div th:text="|• #{legal-stuff.you-agree-to-the-benefit-rules}|"></div>
        <div>
        ...
        <div class="spacing-below-25">
            ...
            <div>
                <span th:text="|• #{legal-stuff.i-acknowledge-that-i-received-the-attached}|"></span>
                <a th:text="#{legal-stuff.notices-of-privacy-practices}" href="https://edocs.dhs.state.mn.us/lfserver/Public/DHS-3979-ENG" target="_blank" rel="noopener noreferrer"></a>
                <span th:text="#{legal-stuff.and}"></span>
                <a th:text="#{legal-stuff.crr}" href="https://edocs.dhs.state.mn.us/lfserver/Public/DHS-4163-ENG" target="_blank" rel="noopener noreferrer"></a>
            </div>
            <div th:text="|• #{legal-stuff.i-agree-to-assign-my-child-support-as-stated-above}|"></div>
            <div th:text="|• #{legal-stuff.i-agree-to-the-sharing-of-information-as-stated-on-the-fraud-release-information}|"></div>
            <div th:text="|• #{legal-stuff.i-agree-to-the-sharing-of-information-as-stated-in-the-social-security-numbers-section}|"></div>
            <div>
                <span th:text="|• #{legal-stuff.i-agree-to-the-sharing-of-information-as-stated-in-the-social-security-numbers-section}|"></span>
                <a th:text="#{legal-stuff.combined-application-form}" href="https://edocs.dhs.state.mn.us/lfserver/Public/DHS-5223-ENG-pform" target="_blank" rel="noopener noreferrer"></a>
            </div>
        </div>
        </div>
</div>
<div th:replace="~{fragments/promptMessageFragments/legal-terms-prompt-notice-privacy :: legal-terms-prompt-notice-privacy}"></div>
 <div th:replace="~{fragments/promptMessageFragments/legal-terms-prompt-client-resp-rights :: legal-terms-prompt-client-resp-rights}"></div>
 <div th:replace="~{fragments/promptMessageFragments/legal-terms-prompt-ccap :: legal-terms-prompt-ccap}"></div>
</div>
</html>
