...
// Avoid failure when not in a git repo (e.g. extracted zip, or Gradle 9 env where git is unavailable)
gitProperties {
...
task genJaxbFilenet {
    ...
    ext.sourcesDir = "${buildRoot}/generated-sources/jaxbFilenet"
    ext.classesDir = "${buildRoot}/classes/jaxb"
...
dependencies {
    ...
    implementation("jakarta.xml.bind:jakarta.xml.bind-api-parent:4.0.5")
    ...
    implementation("org.springframework.session:spring-session-jdbc:4.0.1")
    ...
    implementation("org.springframework.boot:spring-boot-restclient:4.0.1")
    implementation("org.springframework.boot:spring-boot-starter-web-services:4.0.3") {
    ...
    implementation("ch.qos.logback:logback-parent:1.5.32")
    ...
    implementation("org.springframework.boot:spring-boot-starter-data-jdbc-test:4.0.1")
    ...
    implementation("org.springframework.boot:spring-boot-test-autoconfigure:4.0.1")
    ...
    testImplementation("org.seleniumhq.selenium:selenium-api:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-bom:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-chrome-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-chromium-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-devtools-v135:4.33.0")
    testImplementation("org.seleniumhq.selenium:selenium-edge-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-firefox-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-http:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-ie-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-java:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-json:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-manager:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-os:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-remote-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-safari-driver:4.41.0")
    testImplementation("org.seleniumhq.selenium:selenium-support:4.41.0")
    testImplementation("io.percy:percy-java-selenium:2.1.1")
    testImplementation("com.deque.html.axe-core:selenium:4.11.1")
