...
general.validation.enter-race-ethnicity=Make sure you enter a race or ethnicity.
...
housing-provider-info.if-you-are-not-sure=If your're not sure, leave this blank
...
applicant-race-and-ethnicity.title=Race and Ethnicity
applicant-race-and-ethnicity.header=What races or ethnicities do you identify with?
applicant-race-and-ethnicity.prefer-not-to-say=Rather not say
...
household-redirect-page.header-2=Is that okay?
