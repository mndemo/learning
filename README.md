...
# workSituation page is no longer used. However, we keep def. for data-pipelines compatibility
  ...
  - &pastBenefit
    ...
    headerKey:
      defaultValue: past-benefit.header.household
      conditionalValues:
        - value: past-benefit.header
          condition: *livesAlone?
    contextFragment: chooseProgramsContextFragment
    hasPrimaryButton: false
    inputs:
  ...
  - &pastBenefitDetails
    ...
    headerKey:
      defaultValue: past-benefit-details.header.household
      conditionalValues:
        - value: past-benefit-details.header
          condition: *livesAlone?
    contextFragment: chooseProgramsContextFragment
    hasPrimaryButton: true
    primaryButtonTextKey: general.continue
    inputs:
      - name: whenPastBenefits
        ...
        promptMessage:
          promptMessageKey:
            defaultValue: past-benefit-details.when.label.household
            conditionalValues:
              - value: past-benefit-details.when.label
                condition: *livesAlone?
        validators:
          - validation: NOT_BLANK
            errorMessageKey: general.validation.make-sure-you-answer-this-question
      ...
      - name: wherePastBenefitsState
        ...
        promptMessage:
          promptMessageKey:
            defaultValue: past-benefit-details.where.label.household
            conditionalValues:
              - value: past-benefit-details.where.label
                condition: *livesAlone?
        validators:
          - validation: NOT_BLANK
            errorMessageKey: general.validation.make-sure-you-answer-this-question
      - name: whichPastBenefits
        ...
        promptMessage:
          promptMessageKey:
            defaultValue: past-benefit-details.which.label.household
            conditionalValues:
              - value: past-benefit-details.which.label
                condition: *livesAlone?
        helpMessageKey: general.check-all-that-apply
        validators:
          - validation: SELECT_AT_LEAST_ONE
