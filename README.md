...
public class CCAPMockMvcTest extends AbstractShibaMockMvcTest {
  ...
  @Test
  void shouldShowOtherUnearnedIncomeForSnapApplicants() throws Exception {
    completeSingleApplicantFlowToUnearnedIncome("SNAP");

    postExpectingRedirect("unearnedIncome", "unearnedIncome",
        "NO_UNEARNED_INCOME_SELECTED", "otherUnearnedIncome");
  }

  @Test
  void shouldShowOtherUnearnedIncomeForCashApplicants() throws Exception {
    completeSingleApplicantFlowToUnearnedIncome("CASH");
  ...
  @Test
  void shouldSkipOtherUnearnedIncomeWhenUnsupportedProgramsSelected() throws Exception {
    completeSingleApplicantFlowToUnearnedIncome("CERTAIN_POPS");

    postExpectingRedirect("unearnedIncome", "unearnedIncome",
        "NO_UNEARNED_INCOME_SELECTED", "futureIncome");
  }
  ...
  private void completeSingleApplicantFlowToUnearnedIncome(String... programs) throws Exception {
    completeFlowFromLandingPageThroughReviewInfo(programs);
    postExpectingRedirect("addHouseholdMembers", "addHouseholdMembers", "false",
        "introPersonalDetails");
    boolean expectingLivingSituation = Arrays.asList(programs).contains("CERTAIN_POPS");
    if (expectingLivingSituation) {
      postExpectingRedirect("housingSubsidy", "hasHousingSubsidy", "false", "livingSituation");
      postExpectingRedirect("livingSituation", "livingSituation", "UNKNOWN", "goingToSchool");
    } else {
