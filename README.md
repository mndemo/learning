          ...
          - name: otherRaceOrEthnicity
            ...
            validators:
              - validation: ALL_NON_BLANK
                errorMessageKey: general.validation.enter-race-ethnicity
                condition:
                  input: householdRaceAndEthnicity
                  matcher: CONTAINS
                  value: SOME_OTHER_RACE_OR_ETHNICITY
            promptMessage:
              promptMessageKey: race-and-ethnicity.write-your-race-or-ethnicity
  - &applicantRaceAndEthnicity
    name: applicantRaceAndEthnicity
    pageTitle: applicant-race-and-ethnicity.title
    headerHelpMessageKey: race-and-ethnicity.select-all-that-apply
    contextFragment: applicantRaceAndEthnicityFragment
    inputs:
      - name: preferNotToSay
        type: CUSTOM
        ...
        options:
          selectableOptions:
            - value: "true"
              messageKey: applicant-race-and-ethnicity.prefer-not-to-say
      - name: applicantRaceAndEthnicity
        type: CHECKBOX
        options:
          selectableOptions:
          ...
          - name: otherRaceOrEthnicity
            ...
            validators:
              - validation: ALL_NON_BLANK
                errorMessageKey: general.validation.enter-race-ethnicity
                condition:
                  input: applicantRaceAndEthnicity
                  matcher: CONTAINS
                  value: SOME_OTHER_RACE_OR_ETHNICITY
            promptMessage:
              promptMessageKey: race-and-ethnicity.write-your-race-or-ethnicity
...
workflow:
  ...
  personalInfo:
    ...
    nextPages:
      - pageName: applicantRaceAndEthnicity
    datasources:
      - pageName: choosePrograms
  applicantRaceAndEthnicity:
    pageConfiguration: *applicantRaceAndEthnicity
    nextPages:
      - pageName: homeAddress
    datasources:
      - pageName: choosePrograms
